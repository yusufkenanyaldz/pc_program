...
- ⬍ **Aç/Kapat** (collapse)
- 🎚️ **Ayarlar** (⋯ menüsü): renk (R/G/B), şeffaflık, genişlik/yükseklik,
  **simge boyutu, köşe yuvarlaklığı, sıralama, kilit** — canlı önizleme
- 🖱️ **Fare ile Aç/Kapat** — pencere kapalı durur, fare üzerine gelince açılır
- 📁 **Folder Portal** — bir çiti gerçek bir klasöre bağla; içeriği canlı
  gösterilir (FileSystemWatcher), dosya taşınmaz
- 🤖 **Otomatik kurallar** — masaüstüne düşen dosyayı uzantısına göre doğru
